...
class ToolBar(QWidget):
    ...
    def __initWidget(self):
        ...
        self.vBoxLayout.setContentsMargins(36, 22, 10, 0)
...
class SimpleCard(QWidget):
    ...
    def __initLayout(self):
        ...
        self.widget.show()
    def changeAlign(self, part ,target):
        part.setAlignment(target)
    def vBox2Center(self):
...
class SimpleInterface(ScrollArea):
    """ Simple interface """
    ...
    def addSimpleCard(self, title, widget, stretch=0):
